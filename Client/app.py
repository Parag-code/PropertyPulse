...
st.markdown("""
    <div style='background: linear-gradient(45deg, #0f172a, #1e293b); padding: 2rem; border-radius: 10px; color: white; text-align: center; border: 1px solid #6366f1;'>
...
st.sidebar.markdown("""
    <div style='background: #1e293b; padding: 1rem; border-radius: 10px; margin-bottom: 1rem; border: 1px solid #6366f1;'>
...
st.markdown("""
    <div style='background: linear-gradient(45deg, #0f172a, #1e293b); padding: 2rem; border-radius: 10px; color: white; text-align: center; margin-top: 2rem; border: 1px solid #6366f1;'>
